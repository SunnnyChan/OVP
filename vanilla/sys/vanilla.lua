...
local helpers = require 'vanilla.libs.utils'

-- settings
local nginx_conf_source = VANILLA_NGX_PATH .. '/conf_template/nginx.conf'
...
function base_launcher()
    return ngx_handle.new(
        ...
        VANILLA_NGX_PATH .. "/" .. va_conf.app_dirs.tmp .. "/" .. va_conf.env .. "-nginx.conf"
    )
end
